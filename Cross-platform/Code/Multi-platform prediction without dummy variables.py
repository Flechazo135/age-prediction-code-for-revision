...
X = data.drop(['age', 'ID','Dummy_1','Dummy_2'], axis=1)
# X = data.drop(['age', 'ID','Dummy'], axis=1)
y = data['age']
IDs = data['ID']
...
output_file_path_predictions = r"3-Without Dummy results.xlsx"
# output_file_path_predictions = r"2-Without Dummy results.xlsx"
